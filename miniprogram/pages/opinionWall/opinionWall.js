...
Page({
  data: {
    ...
    messages: [{
      ...
      "score": "4.8",
      "level": "5",
      "text_content": "九食堂二楼的菜，强烈推荐！",
      "images_content": ['/images/food1.jpg'],
      "comments_number": 20,
      "like_number": 53,
      "canteen": "九食堂",
      "comments": []
      ...
      "level": "1",
      "text_content": "太好吃了",
      "images_content": ['/images/food2.jpg','/images/food3.jpg'],
      "comments_number": 20,
      "like_number": 53,
      "canteen": "九食堂",
      "comments": [{
  ...
  lookDetail: function (e) {
    wx.navigateTo({
      url: '/pages/opnionWallDetail/opnionWallDetail?message_id=1',
      success: (result) => {},
      fail: (res) => {},
      complete: (res) => {},
    })
